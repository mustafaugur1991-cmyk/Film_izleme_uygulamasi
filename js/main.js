                ...
                <div class="card border-0 shadow-lg p-4" style="color: #506B7D; background-color: #F3F8F9; font-size: 16px;">
                    ...
                    <div class="row">
                        <div class="col-md-4 col-lg-3">
                            ...
                            <button class="btn btn-secondary w-100 fw-bold shadow-sm py-2 mb-3" onclick="window.scrollTo({ top: document.body.scrollHeight, behavior: 'smooth' })">Fragmanı İzle</button>
                            <button class="btn btn-outline-danger w-100 fw-bold py-2" onclick="addToFavorites(${movie.id})">❤ Favorilere Ekle</button>
                        </div>
                        <div class="col-md-8 col-lg-9">
                            <p class="lead lh-base mb-4 movie-description" style="height: 360px; background-color: #EAF0F1; font-size: 16px">
                                ${movie.desc}
                            </p>
                            <ul class="list-group list-group-flush bg-transparent">
                                <li class="list-group-item bg-transparent text-secondary border-secondary px-0" style="font-size: 12px;">
                                ...
                                <li class="list-group-item bg-transparent text-secondary border-secondary px-0" style="font-size: 12px;">
                                    <span class="text-secondary fw-bold">Dil:</span> Türkçe Dublaj / Türkçe Altyazılı
                                </li>
                            </ul>
                        </div>
                    </div>
                            ...
                            <div class="card-body d-flex flex-column">
                                ...
                                <div class="mt-auto">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <span class="badge bg-warning text-dark" style="font-size: 0.7rem;">★ ${movie.imdb}</span>
                                        <span class="text-secondary" style="font-size: 0.7rem;">${movie.category}</span>
                                    </div>
